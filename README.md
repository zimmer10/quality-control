...
Завершены подготовительные этапы R01–R08: метрика, аудит данных, финальные группы и folds, image manifest, визуальные дубли и evidence schema. Обучение моделей ещё не начато.
